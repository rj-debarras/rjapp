...
export default function PourquoiRJDebarras() {
  const us = [
    ...
    <section className="py-24 bg-surface-container-lowest">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-4xl font-display font-extrabold text-primary mb-6">Pourquoi choisir RJ Débarras ?</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          ...
          <div className="bg-primary text-white p-8 rounded-3xl shadow-ambient ring-4 ring-primary/20 relative">
            ...
            <h3 className="text-2xl font-bold font-display mb-6">RJ Débarras</h3>
            <ul className="space-y-4">
              {us.map((item, idx) => (
